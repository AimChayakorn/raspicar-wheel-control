...
#include "rc_pwm_pkg/msg/detail/pwm__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const rc_pwm_pkg::msg::Pwm & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  rc_pwm_pkg::msg::Pwm & ros_message)
{
  // Member: code
  cdr >> ros_message.code;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rc_pwm_pkg::msg::Pwm;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const rc_pwm_pkg::msg::Pwm *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<rc_pwm_pkg::msg::Pwm *>(
    untyped_ros_message);
...
{
  return &rc_pwm_pkg::msg::typesupport_fastrtps_cpp::_Pwm__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rc_pwm_pkg, msg, Pwm)() {
  return &rc_pwm_pkg::msg::typesupport_fastrtps_cpp::_Pwm__handle;
}
