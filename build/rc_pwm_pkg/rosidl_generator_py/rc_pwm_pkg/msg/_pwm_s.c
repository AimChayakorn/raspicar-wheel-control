...
bool rc_pwm_pkg__msg__pwm__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rc_pwm_pkg.msg._pwm.Pwm", full_classname_dest, 23) == 0);
  }
  rc_pwm_pkg__msg__Pwm * ros_message = _ros_message;
  {  // code
...
PyObject * rc_pwm_pkg__msg__pwm__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rc_pwm_pkg.msg._pwm");
