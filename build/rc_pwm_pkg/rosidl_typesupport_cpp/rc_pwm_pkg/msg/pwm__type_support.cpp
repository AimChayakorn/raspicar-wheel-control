...
static const _Pwm_type_support_symbol_names_t _Pwm_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rc_pwm_pkg, msg, Pwm)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rc_pwm_pkg, msg, Pwm)),
  }
};
...
{
  return &::rc_pwm_pkg::msg::rosidl_typesupport_cpp::Pwm_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, rc_pwm_pkg, msg, Pwm)() {
  return get_message_type_support_handle<rc_pwm_pkg::msg::Pwm>();
}
