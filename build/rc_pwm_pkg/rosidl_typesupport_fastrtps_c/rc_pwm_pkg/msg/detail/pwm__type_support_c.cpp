...
#include "rc_pwm_pkg/msg/detail/pwm__rosidl_typesupport_fastrtps_c.h"
...
using _Pwm__ros_msg_type = rc_pwm_pkg__msg__Pwm;
...
size_t get_serialized_size_rc_pwm_pkg__msg__Pwm(
  const void * untyped_ros_message,
...
static uint32_t _Pwm__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rc_pwm_pkg__msg__Pwm(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_rc_pwm_pkg
size_t max_serialized_size_rc_pwm_pkg__msg__Pwm(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rc_pwm_pkg__msg__Pwm;
    is_plain =
      (
...
static size_t _Pwm__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rc_pwm_pkg__msg__Pwm(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rc_pwm_pkg, msg, Pwm)() {
